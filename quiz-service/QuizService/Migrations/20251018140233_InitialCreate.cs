        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionsNum = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CorrectAnsNum = table.Column<long>(type: "bigint", nullable: false),
                    CorrectAnsPercentage = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAnswerChoices", x => new { x.UserAnswerId, x.ChoiceId });
                    table.ForeignKey(
                        name: "FK_UserAnswerChoices_Choices_ChoiceId",
                        column: x => x.ChoiceId,
                        principalTable: "Choices",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserAnswerChoices_UserAnswers_UserAnswerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAnswerChoices_ChoiceId",
                table: "UserAnswerChoices",
                column: "ChoiceId");
